...
echo "[HARNESS] Stage convergence_4x4 (4 pairs, effective width 4)"
...
echo "[HARNESS] Stage hrm_24x24 (capped at 7/24 pairs, effective width 24)"
...
echo "[HARNESS] Stage hrm_24x64 (capped at 7/64 pairs, effective width 64)"
echo "[HARNESS][NOTE] pair width capped by current pair universe size; do not interpret this as a full-width stage"
cd /Users/jim/work/curly-succotash
...
echo "[HARNESS] Stage hrm_24x512 (capped at 7/512 pairs, effective width 512)"
echo "[HARNESS][NOTE] pair width capped by current pair universe size; do not interpret this as a full-width stage"
cd /Users/jim/work/curly-succotash
